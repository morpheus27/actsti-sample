...
include("include/updateabout.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Update About Us | STICaloocan </title>
...
?>
       ...
       <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg20.jpg);background-size:cover;
...
<div class="main-content">
    <p style="font-size:30px;margin-top:5px;margin-left:30px;font-weight:500;color:#000;cursor:default;">MANAGE HOMEPAGE</p>
<p style="font-size:25px;margin-top:5px;position:absolute;margin-left:20px;"></p>
<div class="d-flex justify-content-center align-items-center">
    <div style = "background-color:white;width:800px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
    margin-top:30px;border-radius:10px;" class="table-responsive">
        <p style="font-size:35px;margin-bottom:5px;text-align:center;
        color:#000;font-weight:500;cursor:default;">UPDATE ABOUT US</p>
...
<input type="hidden" name="id" id="id" class="form-control" value="<?php echo $result['id'];?>">
    ...
    <div style="margin-bottom:10px;" class="col">
        <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-15px;">VISION:</label>
    <textarea rows="4" cols="50" style="color:black;margin-top:20px;" class="form-control" id="Vision" name="vision" type="text" required="" autocomplete="off" required><?php echo $result['vision'];?></textarea>
</div>  
</div>
            <div class="form-row mb-4">
    <div style="margin-bottom:10px;" class="col">
        <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-15px;">MISSION:</label>
    <textarea rows="4" cols="50" style="color:black;margin-top:20px;" class="form-control" id="Mission" name="mission" type="text" required="" autocomplete="off" required ><?php echo $result['mission'];?></textarea>
</div>  
</div>

<div class="form-row mb-4">
    <div class="col">
<label style="color:#005baa;font-weight:500;position:absolute;margin-top:-20px;">UPLOAD VIDEO FILE:</label>
        <input class="form-control"  id="file" name="file" placeholder="file" type="file" value="<?php echo $result['file'];?>" required="" accept="video/*">
</div>
</div>

<button style = "background-color:#005baa;color:white;width:200px;margin-top:10px;height:50px;font-weight:500;" type="submit"  name="updateabout" class="btn btn-secondary" onclick="return confirm('Are you sure you want to save changes your data?')">UPDATE</button>
</form>
</div>
        </div>
        <div class="col-md-12">
