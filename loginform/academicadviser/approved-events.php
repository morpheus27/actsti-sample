...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Approved Events | STICaloocan </title>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a href="declined-project.php">
                                <i class="fas fa-times"></i>Declined Project</a>
                        </li>
                        <li>
...
?>
    ...
    <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg14.jpg);background-size:contain;
...
<!-- MAIN CONTENT-->
  ...
  <p style="font-size:30px;margin-top:5px;margin-left:20px;color:#000;
  font-weight:500;cursor:default;">EVENTS APPROVED REQUEST </p>
    <div  class="d-flex justify-content-center align-items-center">
                ...
                margin-top:30px;border-radius:10px;" class="table-responsive">  
                    ...
                    color:black;font-weight:500;cursor:default;">EVENTS DETAILS OF APPROVED REQUEST HISTORY</p>
...
$cnt = 1;
 ...
 {
?>  
                        <tr style= "color:black;font-size:15px;cursor:default;text-align:center;font-weight:500;">
                            ...
                            <td><?php $status = $row['Status']; if($status == 1) { ?> 
                                <center><span style="color:green; font-weight:500;">APPROVED</span></center>
                            <?php } if($status == 2) { ?>
                            ...
                            <td>
                            <center><a style= "background-color:#005baa;margin-left:0px;color:#fff;border:none;" type="button" name="remove" id="remove" class="btn btn-info removebtn" href=events-details.php?eventid=<?php echo $row["lid"];?>>View Details</a></center>
                            </td>    
                        </tr>
                            <?php $cnt++; } ?>
                    </tbody>
