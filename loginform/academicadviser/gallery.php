...
include("include/insertgallery.php");
include("include/updategallery.php");
include("include/delete-gallery.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Update Gallery | STICaloocan </title>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        style="cursor:default;font-size:20px;color:#000;">ADD CSG PHOTO</h5>
      </div>
    ...
    <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">FIRSTNAME:</label>
             <input style="margin-top:20px;height:44px;" type="text" id="Firstname" name="firstname" class="form-control"  placeholder="Enter Firstname" value="">  
        </div> 

      <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">LASTNAME:</label>
            <input style="margin-top:20px;height:44px;" type="text" id="Lastname" name="lastname" class="form-control"  placeholder="Enter Lastname" value="">
        </div> 
    </div>
    <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">POSITION:</label>
            <input style="margin-top:20px;height:44px;" type="text" id="Position" name="position" class="form-control"  placeholder="Enter Position" value="">
        </div> 
    </div>
     ...
     <div class="col">
            ...
            <input style="color:black;margin-top:20px;color:gray;" type="file" id="file" name="file" class="form-control" required=""
            ...
            <button type="submit"  name="insertphoto" class="btn btn-primary" onclick="return confirm('Are you sure you want to insert this data?')">INSERT DATA</button>
            </div>
            </form>
            </div>
                </div>
     ...
     <div class="page-wrapper" style = "background-color:whitesmoke;background-image:url(images/bg18.jpg);background-size:cover;
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <div style="background:url(images/bg-profile/bg1.jpg)no-repeat;background-size:cover;background-position:center;
                            ...
                            <div>
                                <span data-toggle="modal" href="#updateAcademicAdviserModal" style="cursor:pointer;" class="updatebtn" id="span">
...
?>
       ...
       <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg18.jpg);background-size:cover;
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle" style="cursor: default;font-size:25px;margin-left:150px;">REMOVE DATA</h5>
        </div>
      ...
      <div class="modal-body">
       ...
       <div  class="form-row mb-4">
         <div class="col">
            ...
            <label style="font-size: 18px;color:black;">Are you sure you want to delete this data?</label>
         </div>
            </div>

     <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCEL</button>
        <button class="btn btn-primary" type="submit"  name="removedata" class="btn btn-secondary">OK</button>
            </div>
              </form>
      </div>
         </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle" style="cursor: default;font-size:20px;color:#000;">EDIT CSG INFORMATION</h5>
      </div>
      <div class="modal-body">
    ...
    <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">FIRSTNAME:</label>
             <input style="margin-top:20px;height:44px;color:black;" type="text" id="FirstName" name="firstname" class="form-control"  placeholder="Enter Firstname" value="">  
        </div> 

        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">LASTNAME:</label>
            <input style="margin-top:20px;height:44px;color:black;" type="text" id="LastName" name="lastname" class="form-control"  placeholder="Enter Lastname" value="">
        </div>
    </div>
    <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">POSITION:</label>
            <input style="margin-top:20px;height:44px;color:black;" type="text" id="PosiTion" name="position" class="form-control"  placeholder="Enter Position" value="">
        </div> 
    </div>
     ...
     <div class="col">
            <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">UPLOAD IMAGE FILE:</label>
            <input style="color:black;margin-top:20px;color:gray;color:black;" type="file" id="File" name="file" class="form-control" autocomplete="off" accept="image/*">
        </div>
     </div>

            <div class="modal-footer">
             <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCEL</button>
            <button type="submit"  name="updategallery" class="btn btn-primary" onclick="return confirm('Are you sure you want to save changes?')">SAVE CHANGES</button>
            </div>
            </form>
            </div>
                </div>
     ...
     <!-- END UPDATE MODAL -->
       ...
       <div class="main-content">
        ...
        margin-left:20px;font-weight:500;color:#000;cursor:default;">MANAGE HOMEPAGE </p>
         <div class="d-flex justify-content-center align-items-center">
                <div style = "background-color:white;width:96%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
                margin-top:70px;border-radius:10px;" class="table-responsive">  
                    <p style="font-size:35px;margin-bottom:5px;text-align:center;color:#000;font-weight:500;
                              cursor:default;">EDIT CSG GALLERY INFORMATION</p>
                <button style="margin-bottom:20px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModal"data-backdrop="static" data-keyboard="false">ADD CSG PHOTO</button> 
...
?>  
                ...
                <tr style= "color:black;font-size:15px;font-weight:500;text-align:center;cursor:default;">
                    <td><?php echo htmlentities($cnt);?></td>
                    <td><?php echo $row['id'];?></td> 
                    <td><img style="margin-left:50px;width:200px;height:200px;"src="../academicadviser/csgphotos/<?php echo $row['file'];?>" alt="" title=""></td> 
                    <td><?php echo $row['firstname'];?></td>
                    <td><?php echo $row['lastname'];?></td>
                    <td><?php echo $row['position'];?></td>
                        <td><button style= "width:55px;margin-top:5px;" type="button" name="edit" id="edit" class="btn btn-primary editbtn" data-toggle="modal" data-target="#editModal">EDIT</button>
                    <button style= "margin-left:2px;width:75px;margin-top:5px;" type="button" name="remove" id="remove" class="btn btn-primary removebtn">DELETE</button> 
                    </tr>
                    <?php $cnt++; } ?>
                    </tbody>
                </table>  
...
$('#update_id').val(table[1]);
$('#FirstName').val(table[3]);
$('#LastName').val(table[4]);
$('#PosiTion').val(table[5]);
});
