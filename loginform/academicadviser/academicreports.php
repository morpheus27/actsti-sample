...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Academic Liquidation Reports | STICaloocan </title>
...
?>
       ...
       <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg13.jpg);background-size:cover;
       ...
       <div class="main-content">
        <div class="section__content section__content--p30">
        <p style="font-size:30px;color:#000;font-weight:500;cursor:default;">ACADEMIC LIQUIDATION REPORTS</p>
            <div class="d-flex justify-content-center align-items-center">
                <div style = "background-color:#fff;max-width:100%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.2);
                margin-top:30px;border-radius:10px;" class="table-responsive">
                     <p style="text-align:center;font-size:35px;color:#000;font-weight:500;cursor:default;">DETAILS OF EXPENSE REPORT</p>
                     <table style = "margin-left:2px;font-size:1px;" id="tabledit" class="table table-striped table-bordered"> 
                          <thead>  
                               <tr style="font-weight:bolder;font-size:16px;color:#000;text-align:center;">  
                                    <td>N0.</td>
...
<?php
$status=1;
$query = "SELECT academicofficerliquidation.id as lid, csgname.department, academicofficerliquidation.eventdate,academicofficerliquidation.eventtitle,academicofficerliquidation.confirmbudget,
          academicofficerliquidation.totalcost, academicofficerliquidation.file, (confirmbudget - totalcost) as excessbudget, (totalcost - confirmbudget) as shortagebudget 
          FROM academicofficerliquidation JOIN csgname ON academicofficerliquidation.empid = csgname.id ORDER BY lid DESC";
...
$cnt = 1;
 ...
 {
?>  
                                            <tr style= "color:#000; font-size:15px;font-weight:500;text-align:center;cursor:default;">
                                            ...
                                            <td><?php $excessbudget = $row['excessbudget']; 
                                             if($excessbudget > 0) { ?> 
                                             <span style="color:green;font-weight:500;">₱ <?php echo number_format($row['excessbudget']);?></span>
                                            <?php } else { ?>
                                                <span>₱ 0.00 </span>
                                           <?php }?></td> 
                                            ...
                                            if($shortagebudget > 0) { ?> 
                                             <span style="color:red;font-weight:500;">₱ <?php echo number_format($row['shortagebudget']);?></span>
                                            <?php } else { ?>
                                                <span>₱ 0 </span>
                                           <?php }?></td> 
                                        </tr>
                ...
                <div style="margin-top:100px;" class="col-md-12">
                    <div class="copyright">
                        <p class="credit" style="color:#000;font-weight:500;font-size:15px;cursor:default;"> ACTSTI CSG Organization - STICaloocan &nbsp; |  &nbsp; <i class="fa fa-home"></i>  &nbsp; 109 Samson Road corner Caimito Street, Caloocan City 1400</p>  
                        </div>
                </div>
