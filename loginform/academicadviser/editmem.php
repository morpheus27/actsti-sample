...
include("include/academicadviser-action.php");
...
<head>
   <!-- Required meta tags-->
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Update Members Information | STICaloocan </title>
...
<body>
     ...
     <div class="page-wrapper" style = "background-color:whitesmoke;background-image:url(images/bg2.jpg);background-size:cover;
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg2.jpg);background-size:cover;
        background-repeat: no-repeat;" class="page-container">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    ...
                                    <div class="image" style="display:none;">
                                            <img  src="../academicadviser/csg-profile-photos/<?php echo $images;?>" alt="John Doe" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix" style="display:none;">
                                                <div class="image" >
                                                    <a href="#">
                                                        <img style="display:none;" src="../academicadviser/csg-profile-photos/<?php echo $images;?>"/>
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
    ...
    <div class="main-content">
        <p style="font-size:30px;margin-top:5px;position:absolute;
          margin-left:20px;font-weight:500;color:#000;cursor:default;">MANAGE ACADEMIC MEMBERS</p>
        <div  class="d-flex justify-content-center align-items-center">
            <div style = "background-color:#fff;width:1000px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
                          margin-top:100px;border-radius:2%;" class="table-responsive">
                <p style="font-size:35px;margin-bottom:5px;text-align:center;color:#000;font-weight:500;
                          border-bottom:3px solid whitesmoke;padding-bottom:10px;cursor:default;">UPDATE ACADEMIC / STUDENT INFORMATION</p>
...
<?php 
$csgid=intval($_GET['csgid']);
$query = " SELECT * FROM csgname WHERE id = '$csgid'";
$data = mysqli_query($conn, $query);
$result = mysqli_fetch_array($data);
 if ($data)  {
     foreach ($data as $row)  {  
...
?>
    ...
    <div class="form-row mb-2"> 
        <div style="margin-bottom:10px;" class="col">
           <label style="color:#005baa;font-weight:500;float:left;">UNIQUE CSG ID:</label>
           <input style="color:black;height:44px;cursor:default;background-color:white;color:gray;" 
                  class="form-control" id="csgid" name="csgid" type="text" required="" 
                  autocomplete="off"  value="<?php echo $row['csgid'];?>" readonly>
        </div>  
    </div>
    <!-- FIRSTNAME & LASTNAME -->
    <div  class="form-row mb-4">
        <div class="col">
           <label style="color:#005baa;font-weight:500;float:left;">FIRSTNAME:</label>
           <input style="color:black;height:44px;" class="form-control" id="firstname" 
                  name="firstname" value="<?php echo $row['firstname'];?>" type="text"
                  required="" autocomplete="off" maxlength="25">
        </div>
        <div class="col">   
           <label style="color:#005baa;font-weight:500;float:left;">LASTNAME:</label>
           <input style="color:black;height:44px;" class="form-control" id="lastname" 
                  name="lastname" value="<?php echo $row['lastname'];?>" type="text" 
                  required="" autocomplete="off" maxlength="25">
        </div> 
    </div>
     ...
     <div class="form-row mb-4">
        <div style="margin-bottom:10px;" class="col">
            <label style="color:#005baa;font-weight:500;float:left;">OLD PASSWORD:</label>
            <input style="color:black;height:44px;background-color:#fff;cursor:default;" type="password" 
                   id="oldpassword" name="password" class="form-control"  value="<?php echo $row['password'];?>" 
    ...
    <div class="form-row mb-4">
    <div class="col">
            <span onclick="newShowHide()"><i class="fas fa-eye" id = "newEye"></i></span>
            <label style="color:#005baa;font-weight:500;float:left;">NEW PASSWORD:</label>
            <input style="color:black;height:44px;"  type="password" id="newpassword" name="newpassword"  
                   class="form-control" placeholder="New Password" required="" autocomplete="off" >
                  
        </div> 
    <div class="col">
            <span onclick="conShowHide()"><i class="fas fa-eye" id = "conEye"></i></span>
            <label style="color:#005baa;font-weight:500;float:left;">CONFIRM PASSWORD:</label>
            <input style="color:black;height:44px;" type="password" id="confirmpassword" name="confirmpassword"  
                   class="form-control" placeholder="Confirm Password" required="" autocomplete="off">
        </div> 
    </div>

    <!-- MOBILE NUMBER & SELECT DEPARTMENT -->
     <div  class="form-row mb-4">
         <div style="margin-bottom:10px;" class="col">
              <label style="color:#005baa;font-weight:500;float:left;">MOBILE NUMBER:</label>
              <input style="color:black;height:44px;" type="text" id="mobilenumber" name="mobilenumber"
                     class="form-control"  value="<?php echo $row['cpnumber'];?>" maxlength="11" 
                     required="" autocomplete="off">
        </div>
        
        <div class="col">
             <label style="color:#005baa;font-weight:500;float:left;">SELECT DEPARTMENT:</label>
            <select style="height:44px;cursor:pointer;"  name="department"  class="form-control" required="">
             <option  value="" selected disabled>Select Department</option>
             <?php $query = "SELECT * from tbldepartment";
             $data = mysqli_query($conn, $query);
             $result = mysqli_fetch_array($data);
             if ($data)  {
                    foreach ($data as $row)  {  
              ...
              ?>
                <option value="<?php echo $row['departmentcode']?>"><?php echo $row['departmentcode']?>( <?php echo $row['department']?>)</option>
            <?php } }?>    
        </select>
        </div>
    </div>
    ...
    <!-- UPDATE BUTTON -->
    <button style = "background-color:#005baa;color:white;width:200px;margin-top:30px;height:50px;font-weight:500;" type="submit"  name="update" class="btn btn-secondary" onclick="return confirm('Are you sure you want to save changes your data?')">UPDATE</button>   
        </form>
                <?php }?>   
    </div>     
        </div>
...
<script>
function newShowHide() {
    let newPass  = document.getElementById('newpassword');

    if(newPass.type == "password") {
        newPass.type = "text";
        document.getElementById('newEye').style.color="#005baa";
    } else {
        newPass.type = "password";
        document.getElementById('newEye').style.color="gray";
    }
}
...
function conShowHide() {
    ...
    if (conPass.type == "password") {
        conPass.type = "text";
        document.getElementById('conEye').style.color="#005baa";
    } else {
...
jQuery.validator.addMethod("phnumberonly", function(value, element) {
return this.optional(element) || /^(09|\+639)\d{9}$/i.test(value);
}, "Please enter valid phone number(Philippines)");

jQuery.validator.addMethod("number", function(value, element) {
return this.optional(element) || /^(10|\+10)\d{9}$/i.test(value);
}, "Please enter valid Code ID (e.g 10000132940)");
