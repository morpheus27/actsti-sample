...
<head>
   ...
   <title>ACTSTI: Academic Adviser Upcoming Events | STICaloocan </title>
...
<body >
    ...
    <!-- /.container -->
     ...
     <div class="page-wrapper"  style = "background-color:whitesmoke;background-image:url(images/bg25.jpg);background-size:contain;
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    ...
                    <div style="background:url(images/bg-profile/bg1.jpg)no-repeat;background-size:cover;background-position:center;
                                    margin-left:-35px;width:300px;height:210px;margin-top:-35px;margin-bottom:24px;">                        
                         <div>
                            <span data-toggle="modal" href="#updateAcademicAdviserModal"  style="cursor:pointer;" class="editbtn" id="span">
                             ...
                             style="border-radius:50%;width:100px;height:100px;margin-top:24px;
                             margin-left:8px; box-shadow:1px 1px 12px 3px rgba(0,0,0,0.9);" 
                             class="mt-4 ml-2" src="../academicadviser/csg-profile-photos/<?php echo $images;?>" alt="" title=""/>
                             </span> 
                              <p style="color:white;font-size:18px;cursor:default;margin-left:16px;font-weight:600;
                                        margin-top:16px;" class="mt-3 ml-3">
 ...
 <!--   UPDATE PROFILE PICTURE -->
    <div class="modal fade" id="updateAcademicAdviserModal" tabindex="-1" role="dialog" 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div style="margin-top:250px;max-width:450px;margin-left:2vw;" class="modal-content" >
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle"
         style="cursor:default;font-size:20px;margin-top:10px;">UPDATE PROFILE PHOTO</h5>
      ...
      <div class="modal-body">
        <form  id = "FormEdit" action="" method="post" enctype="multipart/form-data">
         ...
         <div class="col">
            <!-- ID  -->
            <input type="hidden" name="update_id" id="update_id" value="<?php echo $photoresult['id'];?>" class="form-control">
         </div>
            </div>
    <div  class="form-row mb-4">
        <div class="col">
            <center>
               <img style="border-radius:100%;margin-top:20px;height:150px;width:155px;border:3px solid #000;" 
      ...
      <div  class="form-row mb-4">
     <div class="col">
            <label style="color:#005baa;font-weight:500;">ADD FILE IMAGE:</label>
...
?>
       ...
       <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg25.jpg);background-size:contain;
                            ...
                            <div class="header-button">
                                <div class="noti-wrap">
                                   <ul style="list-style: none;" class="noti__item">
                                        <li class="dropdown">
                                            <a class="dropdown-toggle" href="#" data-toggle="dropdown"><span style="width:20px;height:20px;right:-12px;"class="quantity count">0</span>
                                                <i style="color:#fff;font-size:25px;margin-top:-3px;" class="zmdi zmdi-notifications" id = "notify" ></i></a>
                                                    <ul class="dropdown-menu" style="overflow:auto;max-height:500px;width:300px;padding:12px;
                                                    margin-left:-65px;margin-top:24px;background-color:#f5f5f5;"></ul>
                                        </li>     
                                    </ul>
                                </div>
...
<div class="main-content">
    <p style="font-size:30px;margin-top:5px;position:absolute;margin-left:20px;
            font-weight:500;color:#000;cursor:default;">UPCOMING EVENTS</p>
    <div  class="d-flex justify-content-center align-items-center">
    <div class="section__content section__content--p30">
        <center><div style = "background-color:white;max-width:1000px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
        margin-top:100px;border-radius:10px;" class="table-responsive" >  
    <div class="row">
        <p style="font-size:35px;margin-bottom:40px;text-align:center;color:#000;font-weight:500;
                    cursor:default;">DETAILS OF UPCOMING EVENTS</p>

        <div class="col-lg-12 text-center">
            <div style="margin-bottom:10px;width:900px;" id="calendar" class="col-centered">
            </div>
        </div>
    </div>
</div></center>
