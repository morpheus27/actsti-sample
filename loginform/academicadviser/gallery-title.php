...
include("include/update-gallerytitle.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Update Gallery Title | STICaloocan </title>
...
?>
       ...
       <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg19.jpg);background-size:cover;
    ...
    <div class="main-content">
          <p style="font-size:30px;margin-top:5px;margin-left:20px;
                    font-weight:500;color:#000;cursor:default;">MANAGE HOMEPAGE </p>
        <p style="font-size:25px;margin-top:5px;position:absolute;margin-left:20px;"></p>
        <div class="d-flex justify-content-center align-items-center">
            <div style = "background-color:white;max-width:1100px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
            margin-top:30px;border-radius:10px;" class="table-responsive">
                <p style="font-size:35px;margin-bottom:5px;text-align:center;
                color:black;font-weight:500;cursor:default;">UPDATE GALLERY IMAGE TITLE</p>

            <form id="FormSubmit" style = "background-color: white;margin-top:10px;border-radius:2%;" 
            class="text border border-light p-5" method="post" enctype="multipart/form-data" autocomplete="off" >
        ...
        <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $result['id'];?>">
         ...
         <div style="margin-bottom:10px;" class="col">
             <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-30px;">GALLERY TITLE:</label>
           <textarea style="margin-top:20px;"  class="form-control" id="Title" name="title" type="text" required="" autocomplete="off" required><?php echo $result['title'];?></textarea>
        </div>  
    </div>
       
        <button style = "background-color:#005baa;color:white;width:200px;margin-top:50px;
        height:50px;font-weight:500;" type="submit"  name="updatetitle" class="btn btn-secondary" 
        onclick="return confirm('Are you sure you want to save changes your data?')">UPDATE
        </button>   
        </form>
        </div>
    </div>
