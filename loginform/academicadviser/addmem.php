...
include("include/insertmember.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Add New Members | STICaloocan </title>
...
<body>
     ...
     <div class="page-wrapper"style = "background-color:whitesmoke;background-image:url(images/bg4.jpg);background-size:cover;
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg4.jpg);background-size:cover;
    ...
    <div class="main-content">
        <p style="font-size:30px;margin-top:5px;position:absolute;margin-left:20px;
        color:#000;font-weight:500;cursor:default;">MANAGE CSG MEMBERS</p>
            <div class="d-flex justify-content-center align-items-center">
                <div style="background-color:white;max-width:1000px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
                margin-top:100px;border-radius:10px;" class="table-responsive">
                    <p style="font-size:35px;margin-top:30px;text-align:center;
                    color:#000;font-weight:500;cursor:default;">ADD NEW STUDENT / ACADEMIC MEMBERS</p>

    <!-- FILL UP FORM -->
    <form id="FormSubmit" style = "background-color: white;border-radius:2%;" class="text border border-light p-5"
    ...
    <div class="form-row mb-4">
        <div class="col">
            ...
            name="csgid" value="<?php echo uniqid('ACTSTICSG')?>" readonly>
        </div> 
    </div>
    <div class="form-row mb-4">
        <div class="col">
            <!-- USERNAME -->
            <label style="color:#005baa;font-weight:500;float:left;">USERNAME:</label>
            <input type="text" class="form-control" placeholder="USERNAME" name="username">
        </div> 
        <div class="col">
            <!-- SELECT USER ROLE -->
            <label style="color:#005baa;font-weight:500;float:left;">CHOOSE ROLE:</label>
            <select style="cursor:pointer;"  name="usertype"  class="form-control" required="">
    ...
    <div class="form-row mb-4">
        ...
        <div class="col">
            ...
            <select style="cursor:pointer;"  name="department"  class="form-control" required="">
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!-- PASSWORD -->
            <label style="color:#005baa;font-weight:500;float:left;">PASSWORD:</label>
            <input type="password" class="form-control" placeholder="PASSWORD" name="password"
            value ="sticaloocan" id ="password">
        </div>
        <div class="col">
            <!-- LASTNAME -->
            <label style="color:#005baa;font-weight:500;float:left;">CONFIRM PASSWORD:</label>
            <input type="password" class="form-control" placeholder="CONFIRM PASSWORD" 
            name="confirmpassword" value ="sticaloocan"> 
        </div>  
    </div>
    <div class="form-row mb-4">
        <div class="col">
            <!-- SCHOOL YEAR AND SEMESTER -->
            <label style="color:#005baa;font-weight:500;float:left;">SCHOOL YEAR & SEMESTER:</label>
            <select style="cursor:pointer;"  name="selectbatch"  class="form-control" required="">
                <option value="" selected disabled>Select School Year & Semester</option>
                ...
                <option value="Fourth Year 1st Sem">Fourth Year 1st Sem</option>
                <option value="Fourth Year 2nd Sem">Fourth Year 2nd Sem</option>
                <option value="Fifth Year 1st Sem">Fifth Year 1st Sem</option> 
                <option value="Fifth Year 2nd Sem">Fifth Year 2nd Sem</option> 
            </select>
        </div>
        <div class="col">
            <!-- BATCH YEAR -->
            <label style="color:#005baa;font-weight:500;float:left;">BATCH YEAR:</label>
            <input type="text" class="form-control" placeholder="CHOOSE BATCH YEAR(E.G 2018-2019)" 
            name="batchyear"> 
        </div>
    </div>

    <button style = "background-color:#005baa;color:white;width:200px;margin-top:20px;height:50px;font-weight:500;"
     type="submit"  name="add" class="btn btn-secondary" onclick="return confirm('Are you sure you want to save changes your data?')">ADD</button>   
    </form>
</div>
    </div>
    <div class="col-md-12">
        <div class="copyright">
        <p class="credit" style ="color:black;font-weight:500;font-size:15px;cursor:default;margin:50px 0px 20px 0px;"> 
        ACTSTI CSG Organization - STICaloocan &nbsp; |  &nbsp; <i class="fa fa-home"></i> 
        &nbsp; 109 Samson Road corner Caimito Street, Caloocan City 1400</p>
     </div>
</div>
...
}, "Please enter valid Code ID (e.g 10000000000)");
...
$( "#FormSubmit" ).validate({
    ...
    messages: {
        ...
        batchyear: {
            required: "Batchyear is required"
        },
