...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Dashboard | STICaloocan </title>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li>
                         ...
                         <li>
                            <a href="csgliquidation.php">
                               <i class="fas fa-list"></i>CSG Reports</a>
                        </li>
                        ...
                        <li class="has-sub">
                                    <a href="insertgallery.php">
                                     <i class="fas fa-user-plus"></i>Insert Gallery</a>
                                </li>

                        <li class="has-sub">
                                    <a href="gallery.php">
                                     <i class="fas fa-pencil-alt"></i>Update Gallery</a>
                                </li>
...
?>
            ...
            <?php
            $status=1;
            $query = "SELECT * from tblprojects WHERE Status = '$status'";
            $result = mysqli_query($conn, $query);
            $data = mysqli_num_rows($result);
            $count = $data;
            ?>              
            ...
            ?>  
                          ...
                          <p style="font-size:30px;margin-top:5px;color:#000;
                          font-weight:500;cursor:default;">LATEST EVENTS PROPOSAL APPLICATIONS</p>
                    </div>
                     ...
                     <table style = "margin-left:2px;" id="tabledit" class="table table-striped table-bordered">  
                          <thead>  
                               <tr style="font-weight:bolder;color:#000;text-align:center;cursor:default;">  
                                    <td>EVENT NO.</td>
                                    <td>EVENT DATE</td>
                                    <td>CSG STUDENT / ACADEMIC OFFICER </td>
                                    <td>EVENT TITLE</td>
                                    <td>DEPARTMENT</td>   
                                    <td>STATUS</td>  
                                    <td>ACTION</td>
...
<?php
$query = "SELECT tblprojects.id as lid, csgname.firstname, csgname.lastname, csgname.department, csgname.id,tblprojects.ProjectType,tblprojects.PostingDate,tblprojects.Status FROM tblprojects JOIN csgname ON tblprojects.empid = csgname.id ORDER BY lid DESC LIMIT 10";
$result = mysqli_query($conn, $query);
$cnt = 1;
...
?>  
                            ...
                            <tr style= "color:black; font-size:15px;text-align:center;cursor:default;font-weight:500;">
...
$("#UpdateAcademicAdviser").validate({
                debug: true,
                      errorClass:'error',
                      validClass:'success',
                      errorElement:'span',
