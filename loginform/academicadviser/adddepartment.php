...
include("include/insertdepartment.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Add New Department | STICaloocan </title>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                                    <a style="cursor:default;" href="#">
                                     <i class="fas fa-pencil-alt"></i>Add Department</a>
                                </li>
                        <li>
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg31.jpg);background-size:cover;
    ...
    <div class="main-content">
          <p style="font-size:30px;margin-top:5px;position:absolute;margin-left:20px;font-weight:500;
                    color:#000;cursor:default;">MANAGE DEPARTMENT </p>
        <p style="font-size: 25px;margin-top:5px;position:absolute;margin-left:20px;"></p>
        <div class="d-flex justify-content-center align-items-center">
            <div style = "background-color:white;width:700px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
            margin-top:180px;border-radius:10px;" class="table-responsive">
                <p style="font-size:35px;margin-bottom:5px;text-align:center;color:#000;
                          font-weight:500;cursor:default;">ADD DEPARTMENT</p>
         ...
         <div style="margin-bottom:10px;" class="col">
             <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-15px;">DEPARTMENT:</label>
           <input style="color:black;height:44px;margin-top:20px;" class="form-control" id="department" name="department" placeholder="Add Department (e.g. Bachelor of Science in Information Technology)" type="text" required="" autocomplete="off">
        </div>  
    </div>

        <div class="form-row mb-4">
         <div style="margin-bottom:10px;" class="col">
             <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-15px;">DEPARTMENT CODE:</label>
           <input style="color:black;height:44px;margin-top:20px;" class="form-control" id="departmentcode" name="departmentcode" placeholder="Add Department Code (e.g. BSIT)" type="text" required="" autocomplete="off">
        </div>  
    </div>

    <button style = "background-color:#005baa;color:white;width:200px;margin-top:10px;height:50px;font-weight:500;" type="submit"  name="add" class="btn btn-secondary" onclick="return confirm('Are you sure you want to save changes your data?')">ADD</button>   
        </form>
        </div>
    </div>
<div class="col-md-12">
    <div class="copyright">
        <p class="credit" style ="color:black;font-weight:500;font-size:15px;cursor:default;margin:150px 0px 20px 0px;">ACTSTI CSG Organization - STICaloocan &nbsp; | 
...
$( "#FormSubmit" ).validate({
    ...
    rules: {
        department: {
            required:true,
            remote: {
                url:"include/check-department.php",
                type:"post"
            }
        },
        ...
        departmentcode: {
            required:true,
            remote: {
                url:"include/check-departmentcode.php",
                type:"post"
            }
        }
    },
    ...
    messages: {
        department: {
            ...
            remote:"Department is already created"
        },

        departmentcode: {
            required: "Department Code is required",
            remote:"Department Code is already created"
        },
        },
