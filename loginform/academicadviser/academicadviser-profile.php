...
include ("include/update-academicadviser.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Account settingss | STICaloocan </title>
...
<body>
    ...
    <div class="page-wrapper" style="background-color:whitesmoke;background-image:url(images/bg26.jpg);background-size:contain;
...
?>  
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg26.jpg);background-size:contain;
...
<div class="main-content">
    <p style="font-size:30px;margin-top:5px;position:absolute;margin-left:20px;
            font-weight:500;color:#000;cursor:default;">PROFILE SETTINGS</p>
    <div class="d-flex justify-content-center align-items-center">


<!-- ACCOUNT SETTINGS -->
<form  id="FormSubmit" style="background-color:#fff;width:900px;padding:20px;
box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);margin-top:100px;border-radius:10px;" 
class="text-center border border-light p-5" method="post" enctype="multipart/form-data">
            <p style="font-size:35px;margin-bottom:5px;text-align:center;
                        color:#000;font-weight:500;cursor:default;">ACCOUNT SETTINGS</p>
...
<div class="col">
    <!--Address-->
    <label style="color:#005baa;font-weight:500;float:left;">ADDRESS:</label>
        <input class="form-control"  id="address" name="address" placeholder="address" type="text" value="<?php echo $result['address'];?>">
</div>
</div>

<!-- Update button -->
<input onclick="return  confirm('Are you sure you want to save changes?')" style="margin-top:40px;width:200px;font-weight:500;" class="form-control" id = "update"  type="submit"  name="update" value="SAVE CHANGES">
</form>
</div>
    <div class="col-md-12">
        <div class="copyright">
...
$("#message-container").scroll(function(){
    ...
    var yHeight = value.scrollHeight - 376; //This is the height of message container;
     if(xTop < yHeight){
        action = false;
    } else {
         action = true;
