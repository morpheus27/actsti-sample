...
include("include/academicadviser-changepass.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Change Password | STICaloocan </title>
...
<body>
    ...
    <div class="page-wrapper" style ="background-color:whitesmoke;background-image:url(images/bg27.jpg);
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg27.jpg);background-size:cover;
...
<div class="main-content">
    <p style="font-size:30px;margin-top:5px;position:absolute;margin-left:20px;font-weight:500;
                color:#000;cursor:default;">PROFILE SETTINGS</p>
        <div  class="d-flex justify-content-center align-items-center">

<!-- CHANGE PASSWORD SETTINGS -->
<form id="FormSubmit" style = "background-color:white;width:700px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);margin-top:100px;border-radius:10px;" class="text-center border border-light p-5" method="post" >
...
<div class="col">
    ...
    <!-- Update button -->
<input onclick="return  confirm('Are you sure you want to save changes?')" style="margin-top: 40px;width: 50%;" class="form-control" id = "update"  type="submit"  name="update" value="SAVE CHANGES">
</form>
    </div>
    <div class="col-md-12">
        <div class="copyright">
