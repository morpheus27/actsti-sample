...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Pending Events | STICaloocan </title>
...
?>    
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg17.jpg);background-size:cover;
...
<!-- MAIN CONTENT-->
       <div class="main-content">
        ...
        color:#000;font-weight:500;cursor:default;">EVENTS PENDING REQUEST </p>
         <div class="d-flex justify-content-center align-items-center">
                <div style = "background-color:#fff;max-width:96%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
                margin-top:30px;border-radius:10px;" class="table-responsive">  
                     ...
                     font-weight:500;cursor:default;">EVENTS DETAILS OF PENDING REQUEST HISTORY</p>
                     ...
                     <table style = "margin-left:2px;" id="tabledit" class="table table-striped table-bordered">  
                          <thead>  
                               <tr style="font-weight:bolder;color:#000;text-align:center;">  
                                    <td>EVENT NO.</td>
                                    <td>STUDENT / ACADEMIC OFFICER</td>
                                    <td>EVENT TITLE</td>
                                    <td>DEPARTMENT</td>   
                                    <td>STATUS</td>  
                                    <td>ACTION</td>
...
?>  
                            ...
                            <tr style= "font-size:15px;font-weight:500;color:#000;cursor:default;text-align:center;">
                                ...
                                <td>
                                <a style= "background-color:#005baa;margin-left:0px;color:#fff;border:none;" type="button" name="remove" id="remove" 
                                class="btn btn-info removebtn" href=events-details.php?eventid=<?php echo $row["lid"];?>>View Details</a>
                                </td>    
                            </tr>
                                <?php $cnt++; } ?>
                        </tbody>
