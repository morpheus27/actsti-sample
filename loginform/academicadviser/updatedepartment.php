...
include("include/editdepartment.php");
include("include/delete-department.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Adviser Update Department | STICaloocan </title>
...
<body>
    ...
    <div class="page-wrapper" style = "background-color:whitesmoke;background-image:url(images/bg33.jpg);background-size:cover;
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="academicrequest.php">
                                <i class="fas fa-pencil-alt"></i>Request Event</a>
                        </li>
                         <li class="has-sub">
                        ...
                        <li>
                            <a href="academicprofile.php">
                                 <i class="zmdi zmdi-account"></i>Account Settings</a>
                        </li>
                         <li>
                            <a href="academic-changepass.php">
...
?>
        <!-- PAGE CONTAINER-->
        <div style = "background-color:whitesmoke;background-image:url(images/bg33.jpg);background-size:cover;
        background-repeat: no-repeat;" class="page-container">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle" 
        style="cursor:default;font-size:25px;margin-left:150px;color:#000;">REMOVE DATA</h5>
        </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle" style="cursor:default;font-size:20px;color:#000;">EDIT LIQUIDATION REPORTS</h5>
      </div>
      <div class="modal-body">
    ...
    <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">DEPARTMENT NAME:</label>
            <input style="margin-top:20px;height:44px;color:black;" type="text" id="editDepartment" name="editdepartment" class="form-control"  placeholder="Enter Event Title" value="">
        </div> 
    </div>

      <div  class="form-row mb-4">
        <div class="col">
                 <label style="color:#005baa;font-weight:500;position:absolute;margin-top:-10px;">DEPARTMENT CODE:</label>
            <input style="margin-top:20px;height:44px;color:black;" type="text" id="editDepartmentCode" name="editdepartmentcode" class="form-control"  placeholder="Enter Event Title" value="">
        </div> 
    </div>
...
<!-- MAIN CONTENT-->
       <div class="main-content">
        <p style="font-size:30px;margin-top:5px;margin-left:20px;font-weight:500;color:#000;cursor:default;">MANAGE DEPARTMENT</p>
             <div  class="d-flex justify-content-center align-items-center">
                <div style = "background-color:#fff;max-width:97%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.2);
                   margin-top:30px;border-radius:10px;" class="table-responsive">
                    <p style="font-size:35px;margin-bottom:5px;text-align:center;color:#000;
                              font-weight:500;cursor:default;">UPDATE DEPARTMENT</p>
...
<?php
$query = "SELECT id,department, departmentcode, creationdate FROM tbldepartment";
...
?>  
            ...
            <tr style= "color:#000;font-size:15px;text-align:center;font-weight:500;cursor:default;">
                ...
                <td><button style= "margin-top:5px;width:45px;" type="button" name="edit" id="edit" class="btn btn-primary editbtn"data-toggle="modal" data-target="#editModal"><i class="fas fa-pencil-alt"></i></button>
                <button style= "margin-left:5px;margin-top:5px;width:45px;" type="button" name="remove" id="remove" class="btn btn-primary removebtn"><i class="fas fa-times"></i></button>
                </td>   
                </tr>
                <?php $cnt++; } ?>
                </tbody>
...
$('.editbtn').on('click', function() {
    ...
    console.log(table);
    $('#update_id').val(table[0]);
    $('#editDepartment').val(table[3]);
    $('#editDepartmentCode').val(table[4]);
});
