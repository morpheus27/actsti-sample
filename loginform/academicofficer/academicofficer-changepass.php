...
include("include/academicofficer-updatepassword.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Officer Change Password | STICaloocan </title>
...
?>
        ...
        <!-- PAGE CONTAINER-->
          <div style = "background-image:url(images/csg11.jfif);background-size:cover;background-repeat: no-repeat;" class="page-container">
   ...
   <div class="modal fade" id="EditAcademicOfficerPhoto" tabindex="-1" role="dialog" 
    ...
    <!-- CHANGEPASSWORD FORM -->
        <form id="FormSubmit" style = "background-color:white;width:800px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
        margin-top:50px;border-radius:10px;" class="text-center border border-light p-5"  method="post" >
           <p style="color:black;font-size:35px;cursor:default;" class="h1 mb-4">CHANGE PASSWORD</p>
    ...
    <div class="form-row mb-4">
     ...
     <div class="form-row mb-4">
        <div class="col">
            ...
            <input style="margin-top:25px;" type="password" id="newpassword" name="newpassword"  placeholder="NEW PASSWORD" class="form-control">
        </div>
    </div>
    ...
    <div class="form-row mb-4">
        <div class="col">
            ...
            <label style="color:#005baa;font-weight:500;float:left;">CONFIRM NEW PASSWORD</label>
            <input style="margin-top:25px;" class="form-control"  id="confirmpassword" name="confirmpassword" placeholder="CONFIRM PASSWORD" type="password">
        </div>
    </div>
            <!-- Update button -->
    <input onclick="return  confirm('Are you sure you want to save changes?')" style="margin-top:40px;width:200px;" class="form-control" 
            id = "update"  type="submit"  name="update" value="SAVE CHANGES">
</form>
     </div>
        <div class="col-md-12 mt-5">
            <div class="copyright">
                <p class="credit" style="color:#000;font-weight:500;font-size:15px;cursor:default;margin-top:100px;"> ACTSTI CSG Organization - STICaloocan &nbsp; |  &nbsp; <i class="fa fa-home">
    ...
    $( "#FormSubmit" ).validate({
        ...
        messages: {
            ...
            newpassword: {
                ...
                minlength: "Must be at least 8-16  alphanumeric characters."
