...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Officer Declined Events | STICaloocan </title>
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-image:url(images/csg15.jpg);background-size:cover;background-repeat:no-repeat;" class="page-container">
...
<!-- MAIN CONTENT-->
       <div class="main-content">
        <p style="font-size:30px;margin-top:5px;margin-left:20px;color:#000;font-weight:500;cursor:default;">EVENTS DECLINED REQUEST </p>
            <div  class="d-flex justify-content-center align-items-center">
                <div style = "background-color:white;max-width:97%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);margin-top:30px;border-radius:5px;" class="table-responsive">  
                    <p style="font-size:35px;margin-bottom:5px;text-align: center;color:#000;font-weight:500;cursor:default;">EVENTS DETAILS OF DECLINED REQUEST HISTORY</p>
...
?>  
                    ...
                    <div class="col-md-12 mt-5" style="margin-top:100px;">
                        <div class="copyright">
                            <p class="credit" style ="color:#000;cursor:default;font-size:15px;font-weight:500;margin-top:400px;"> ACTSTI CSG Organization - STICaloocan &nbsp; |  &nbsp; <i class="fa fa-home">                           
