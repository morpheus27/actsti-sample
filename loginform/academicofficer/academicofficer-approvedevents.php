...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Officer Approved Events | STICaloocan </title>
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-image:url(images/csg5.jpg);background-size:cover;background-repeat: no-repeat;" class="page-container">
...
<!-- MAIN CONTENT-->
       <div class="main-content">
        <p style="font-size:30px;margin-top:5px;margin-left:20px;color:#000;font-weight:500;cursor:default;">EVENTS APPROVED REQUEST</p>
            <div  class="d-flex justify-content-center align-items-center">
                <div style = "background-color:white;max-width:96%;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);margin-top:30px;border-radius:1%;" class="table-responsive">  
                    <p style="font-size:35px;margin-bottom:5px;text-align: center;color:#000;font-weight:500;cursor:default;">EVENTS DETAILS OF APPROVED REQUEST HISTORY</p>
...
?>  
                                        ...
                                        <tr style= "color:black; font-size:15px;cursor:default;font-weight:500;text-align:center;">
                                        ...
                                        <?php } ?>               
                                          ...
                                          <td> <a href="../academicadviser/uploadevents/<?php echo $row['file'];?>"><?php echo $row['file'];?></a></td>
                                             <td>
                                       <center><a style= "background-color:#005baa;margin-left:0px;color:#fff;border:none;" type="button" name="remove" id="remove" class="btn btn-info removebtn" href=academicofficer-eventdetails.php?eventid=<?php echo $row["lid"];?>>View Details</a></center>
                                            </td>    
                                        </tr>
                                         <?php $cnt++; } ?>
                                </tbody>
