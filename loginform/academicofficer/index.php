...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Officer Dashboard | STICaloocan </title>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="studentpropose.php">
                                <i class="fas fa-pencil-alt"></i>Request Events</a>
                        </li>
                         <li>
                            <a href="student-liquidation.php">
...
?>
        ...
        <!-- PAGE CONTAINER-->
        <div style = "background-image:url(images/csg2.jfif);background-size:cover;
    ...
    <div  class="form-row mb-4">
     ...
     <!-- END UPDATE MODAL -->
            ...
            <div class="main-content">
               <div class="section__content section__content--p30">
                 <p style="font-size:30px;color:#000;font-weight:500;cursor:default;">DASHBOARD</p>
                  <div class="row m-t-25">
            <?php
            $ao=$_SESSION['ao'];
            $query = "SELECT * from tblprojects WHERE empid = '$ao'";
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div style="height:70px;" class="overview-box clearfix">
                                            <div class="icon">
                                               <i id ="envelope" class="fas fa-envelope-open"></i>
                                            </div>
                                            <div style="margin-top:30px;position:absolute;margin-left:40px;" class="text">
                                                <h2 class="one"><?php echo htmlentities($count)?></h2>
                                                <span class ="totalrequest" >Total Events Request</span>
                                            </div>
                                        </div>
            ...
            $ao=$_SESSION['ao'];
            $status=1;
            $query = "SELECT * from tblprojects WHERE Status = '$status' AND empid = '$ao'";
            $result = mysqli_query($conn, $query);
            $data = mysqli_num_rows($result);
            $count = $data;
            ?>              
                                ...
                                <div  class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div style="height:70px;" class="overview-box clearfix">
                                           ...
                                           <div style="margin-top:30px;position:absolute;margin-left:30px;" class="text">
                                                <h2 class="two"><?php echo htmlentities($count)?></h2>
                                                <span class="totalapproved">Total Approved Events Request</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                        </div>
                                ...
                                <div class="overview-item overview-item--c3">
                                    <div class="overview__inner">
                                        <div style="height:70px;" class="overview-box clearfix">
                                            ...
                                            <div style="margin-top:30px;position:absolute;margin-left:40px;" class="text">
                                                <h2 class="three"><?php echo htmlentities($count)?></h2>
                                                <span class="totaldeclined">Total Declined Events Request</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                        </div>
            ...
            ?>  
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div style="height:70px;" class="overview-box clearfix">
                                           ...
                                           <div style="margin-top:30px;position:absolute;margin-left:40px;" class="text">
                                                <h2 class="four"><?php echo htmlentities($count)?></h2>
                                                <span class="totalpending">Total Pending Events Request</span>
                                            </div>
                                        </div>
                                        <div class="overview-chart">
                                        </div>
                          ...
                          <p style="font-size:30px;margin-top:5px;color:#000;font-weight:500;cursor:default;">LATEST EVENTS PROPOSAL APPLICATIONS</p>
                    </div>
                <div  class="d-flex justify-content-center align-items-center">
                <div style = "background-color:white;width:96%;padding:25px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);
                margin-top:20px;border-radius:10px;" class="table-responsive"> 

                     <table style = "margin-left:2px;" id="tabledit" class="table table-striped table-bordered">  
                          <thead>  
                               <tr style="font-weight:bolder;color:#000;text-align:center;cursor:default;">  
                                    <td>EVENT NO</td>
                                    <td>EVENT DATE</td>
                                    <td>EVENT TITLE</td>    
                                    <td>DEPARTMENT</td>   
...
<?php
$ao=$_SESSION['ao'];
$query = "SELECT tblprojects.id as lid, csgname.firstname, csgname.lastname, csgname.department, csgname.id,tblprojects.ProjectType,tblprojects.PostingDate,tblprojects.Status FROM tblprojects JOIN csgname ON tblprojects.empid = csgname.id WHERE tblprojects.empid = '$ao' ORDER BY lid DESC LIMIT 10";
$result = mysqli_query($conn, $query);
$cnt = 1;
...
?>  
                                        ...
                                        <?php } ?>               
                                             ...
                                             <td>
                                            <center><a style= "background-color:#005baa;margin-left:0px;color:#fff;border:none;font-weight:500;" type="button" name="remove" id="remove" class="btn btn-info removebtn" href=academicofficer-eventdetails.php?eventid=<?php echo $row["lid"];?>>View Details</a></center>
                                            </td>    
                                        </tr>
                                         <?php $cnt++; } ?>
                                    </tbody>
                        ...
                        <div class="col-md-12 mt-5">
                            <div class="copyright">
                                <p class="credit" style="color:#000;font-weight:500;font-size:15px;cursor:default;"> ACTSTI CSG Organization - STICaloocan &nbsp; |  &nbsp; <i class="fa fa-home">
