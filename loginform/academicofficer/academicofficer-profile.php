...
include("include/academicoffcer-updateprofile.php");
...
<head>
    ...
    <!-- Title Page-->
    <title>ACTSTI: Academic Officer Account Information | STICaloocan </title>
...
?>
        ...
        <!-- PAGE CONTAINER-->
          <div style = "background-image:url(images/csg30.jpg);background-size:cover;background-repeat: no-repeat;" class="page-container">
  ...
  <div class="modal fade" id="EditAcademicOfficerPhoto" tabindex="-1" role="dialog" 
    ...
    <!-- MAIN CONTENT-->
       <div class="main-content">
         <p style="font-size:30px;margin-top:5px;margin-left:20px;color:#000;font-weight:500;cursor:default;">PROFILE SETTINGS</p>
           <div class="d-flex justify-content-center align-items-center">

    <!-- Account settings-->
        <form  id="FormSubmit" style = "background-color:white;width:800px;padding:20px;box-shadow:1px 1px 12px 3px rgba(0,0,0,0.3);margin-top:30px;border-radius:10px;" 
        class="text-center border border-light p-5"  method="post" enctype="multipart/form-data">
        
           <p style="color:black;font-size:35px;text-align:center;font-weight:500;cursor:default;" class="h1 mb-4">ACCOUNT INFORMATION</p>
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!-- Username -->
            <label style="color:#005baa;font-weight:500;float:left;">POSITION / ROLE:</label>
            <input type="text" id="username" class="form-control" value="<?php echo $result['username'];?>"disabled>
        </div>
    </div>
     ...
     <div class="form-row mb-4">
        <div class="col">
            ...
            <input type="text" id="firstname" name="firstname" class="form-control"  placeholder="Firstname" value="<?php echo $result['firstname'];?>">
        </div>

        <div class="col">
            <!-- Lastname -->
            <label style="color:#005baa;font-weight:500;float:left;">LASTNAME:</label>
            <input type="text" id="lastname"  name="lastname" class="form-control" placeholder="Lastname" value="<?php echo $result['lastname'];?>">
        </div>
    </div>
     ...
     <div  class="form-row mb-4">
        <div class="col">
            <!-- CPNUMBER-->
            <label style="color:#005baa;font-weight:500;float:left;">PHONE NUMBER:</label>
            <input type="text" maxlength="11" id="cpnumber" name="cpnumber" class="form-control"  placeholder="Cellphone Number" value="<?php echo $result['cpnumber'];?>">
        </div>
    </div>
    ...
    <div class="form-row mb-4">
        <div class="col">
            <!--Address-->
            <label style="color:#005baa;font-weight:500;float:left;">HOME ADDRESS:</label>
             <input class="form-control"  id="address" name="address" placeholder="address" type="text" value="<?php echo $result['address'];?>">
        </div>
    </div>
            <!-- Update button -->
    <input onclick="return confirm('Are you sure you want to save changes?')" style="margin-top:60px;margin-bottom:20px;width:200px;" class="form-control" id = "update"  type="submit"  name="update" value="SAVE CHANGES">
    </form>
     </div>
